...
echo "******************************************************************************"
yum install -q -y docker-engine yum-plugin-ovl   # btrfs-progs btrfs-progs-devel
yum install -q -y ansible python-3 python3-pip  python3-devel
yum install -q -y bind-utils xterm tcpdump
yum install kernel-devel-4.14.35-1902.10.4.1.el7uek.x86_64
# AWX requirement.
